...
<div class="page-wrapper">
        ...
        <h5 style="margin-top: -25px; margin-bottom: 12px;">Update Route Path</h5>
    ...
    <div class="row">
        ...
        <div class="col-md-3">
            <form action="{{ route('polyline_update', $polyline->id) }}" method="post" id="pathForm">
                @csrf
                @method('PATCH')
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <button class="btn btn-block btn-success" id="save">Update Path</button>
        </div>
    </div>
