        ...
        <div class="page-w card-header p-1 m-0" >
            <form action="">
                ...
                <div class="form-group col-md-2 m-0">
                    ...
                    <button type="button" class="btn get-data-paid" style="background: #0071f3">Submit</button>
                </div>
                </div>
            </form>
        </div>
            ...
            <div class="tab-content" id="nav-tabContent">
                <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                    <div class="table-responsive">
                        <p class="table-title-vehicle"><span style="color: #0071f3">Paid Invoices</span> - List Viewer <span class="pl-5 total"></span></p>
